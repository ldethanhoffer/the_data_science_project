...
\usepackage{amsmath,amsthm,amsfonts,amssymb,tikz,scalerel}
% load calligraphic font
%\usepackage{mathrsfs}
\usepackage{marvosym,titlesec}
...
\externaldocument[linear_algebra-]{linear_algebra/linear_algebra}
\externaldocument[probability-]{probability}



%change the default font to gfsbodoni
...
%imake interline a little larger
\linespread{1.28}
